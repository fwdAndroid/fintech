...
class FintechIconButton extends StatefulWidget {
  const FintechIconButton({
    Key? key,
    required this.icon,
    this.borderColor,
    this.borderRadius,
  ...
  @override
  State<FintechIconButton> createState() => _FintechIconButtonState();
}

class _FintechIconButtonState extends State<FintechIconButton> {
  bool loading = false;
  ...
  @override
  void didUpdateWidget(FintechIconButton oldWidget) {
