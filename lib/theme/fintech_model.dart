...
Widget wrapWithModel<T extends FintechModel>({
  required T model,
...
T createModel<T extends FintechModel>(
...
class FintechDynamicModels<T extends FintechModel> {
  FintechDynamicModels(this.defaultBuilder);
