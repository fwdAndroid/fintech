...
class FintechCheckboxGroup extends StatefulWidget {
  const FintechCheckboxGroup({
  ...
  @override
  State<FintechCheckboxGroup> createState() => _FintechCheckboxGroupState();
}

class _FintechCheckboxGroupState extends State<FintechCheckboxGroup> {
