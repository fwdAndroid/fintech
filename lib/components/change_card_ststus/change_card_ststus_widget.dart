...
import 'change_card_ststus_model.dart';
export 'change_card_ststus_model.dart';

class ChangeCardStstusWidget extends StatefulWidget {
  const ChangeCardStstusWidget({Key? key}) : super(key: key);
...
class _ChangeCardStstusWidgetState extends State<ChangeCardStstusWidget> {
  late ChangeCardStstusModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChangeCardStstusModel());
  }
