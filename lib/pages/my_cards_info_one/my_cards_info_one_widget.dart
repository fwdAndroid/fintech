...
import 'my_cards_info_one_model.dart';
export 'my_cards_info_one_model.dart';

class MyCardsInfoOneWidget extends StatefulWidget {
  const MyCardsInfoOneWidget({Key? key}) : super(key: key);

  @override
  _MyCardsInfoOneWidgetState createState() => _MyCardsInfoOneWidgetState();
}

class _MyCardsInfoOneWidgetState extends State<MyCardsInfoOneWidget> {
  late MyCardsInfoOneModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MyCardsInfoOneModel());
  }
