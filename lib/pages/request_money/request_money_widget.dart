...
import 'request_money_model.dart';
export 'request_money_model.dart';

class RequestMoneyWidget extends StatefulWidget {
  const RequestMoneyWidget({Key? key}) : super(key: key);

  @override
  _RequestMoneyWidgetState createState() => _RequestMoneyWidgetState();
}

class _RequestMoneyWidgetState extends State<RequestMoneyWidget> {
  late RequestMoneyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RequestMoneyModel());
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: Image.asset(
                                              'assets/images/Ellipse_61_(1).png',
                                              fit: BoxFit.none,
                                            ),
                                          ),
                                          Padding(
